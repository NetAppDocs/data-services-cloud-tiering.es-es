...
https://www.netapp.com/data-services/tiering/tco-calculator/["Utilice la calculadora de TCO de Cloud Tiering para ver cuánto dinero puede ahorrar"^].
...
Después de comprar una licencia de Cloud Tiering, deberá agregar la licencia a la NetApp Console. link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-byol-license["Vea cómo usar una licencia BYOL de Cloud Tiering"].
...
NOTE: A partir de agosto de 2021, la antigua licencia * FabricPool* fue reemplazada por la licencia *Cloud Tiering*. link:task-licensing-cloud-tiering.html#cloud-tiering-byol-licensing-starting-in-2021["Obtenga más información sobre en qué se diferencia la licencia Cloud Tiering de la licencia FabricPool"].
